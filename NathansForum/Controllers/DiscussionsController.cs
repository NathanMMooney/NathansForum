...
namespace NathansForum.Controllers
{
    public class DiscussionsController : Controller
    {
        ...
        public DiscussionsController(NathansForumContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DiscussionId,Title,Content,ImageFile,CreateDate")] Discussion discussion)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (discussion.ImageFile != null)
                {
                    ...
                    using (var fileStream = new FileStream(filepath, FileMode.Create)) { await discussion.ImageFile.CopyToAsync(fileStream); }
                }
